...
@Component({
  selector: 'app-iso-22000',
  imports: [CommonModule, ReactiveFormsModule, RouterModule, PhoneInputComponent],
  templateUrl: './iso-22000.component.html',
  styleUrl: './iso-22000.component.scss'
})
export class Iso22000Component implements OnInit {
  ...
  submit() {
    ...
    const lead: NewLead = {
      ...
      city: fv.city!,
      comments: `ISO 22000:2018 | Business: ${fv.businessName}`
    };
