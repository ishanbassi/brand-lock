...
export class AboutUsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.meta.updateTag({ name: 'description', content: 'Meet the Trademarx team — Anil Bassi (20+ years, 10,000+ marks) and Ishan Bassi (400+ marks). IP India authorised trademark agents based in Ludhiana, Punjab.' });
