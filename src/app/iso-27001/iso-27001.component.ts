...
@Component({
  selector: 'app-iso-27001',
  imports: [CommonModule, ReactiveFormsModule, RouterModule, PhoneInputComponent],
  templateUrl: './iso-27001.component.html',
  styleUrl: './iso-27001.component.scss'
})
export class Iso27001Component implements OnInit {
  ...
  submit() {
    ...
    const lead: NewLead = {
      ...
      city: fv.city!,
      comments: `ISO 27001:2022 | Business: ${fv.businessName}`
    };
      ...
      .subscribe({
        next: (response) => {
          ...
          this.router.navigate(['/service-checkout'], {
            queryParams: { service: 'ISO_27001', lead_id: response.body?.id }
          });
        },
