...
@Component({
  selector: 'app-iso-45001',
  imports: [CommonModule, ReactiveFormsModule, RouterModule, PhoneInputComponent],
  templateUrl: './iso-45001.component.html',
  styleUrl: './iso-45001.component.scss'
})
export class Iso45001Component implements OnInit {
  ...
  submit() {
    ...
    const lead: NewLead = {
      ...
      city: fv.city!,
      comments: `ISO 45001:2018 | Business: ${fv.businessName}`
    };
      ...
      .subscribe({
        next: (response) => {
          ...
          this.router.navigate(['/service-checkout'], {
            queryParams: { service: 'ISO_45001', lead_id: response.body?.id }
          });
        },
